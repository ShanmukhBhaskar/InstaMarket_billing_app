        ...
        <Form layout="vertical" onFinish={onFinish}>
          ...
          <Form.Item name="paymentMode" label="Payment Mode">
            <Select>
              ...
              <Select.Option value="card">Sodex-o Pass</Select.Option>
              <Select.Option value="card">UPI</Select.Option>
            </Select>
          </Form.Item>
          ...
          <div className="charge-bill-amount">
            ...
            <h5>
              Tax : <b>{((subTotal / 100) * 8).toFixed(2)}</b>
            </h5>
            <hr />
            <h2>
              Total : <b>{subTotal + (subTotal / 100) * 8}</b>
            </h2>
          </div>
